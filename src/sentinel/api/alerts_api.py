...
def list_alerts(
    ...
    Returns:
        List of SentinelAlert models, sorted by canonical order (repo handles sorting)
    """
    ...
    # Convert to SentinelAlert models
    return [_alert_row_to_sentinel_alert(a) for a in filtered]
...
def get_alert_detail(
    ...
    # Convert to SentinelAlert
    alert = _alert_row_to_sentinel_alert(alert_row)
